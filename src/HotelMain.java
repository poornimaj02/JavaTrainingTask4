public class HotelMain {
    public static void main(String[] args) {
        ...
        Guest guest1 = new Guest(1, "sham", "singh", "sham@gamil.com");
        Guest guest2 = new Guest(2, "usha", "rani", "usha@gamil.com");
        Guest guest3 = new Guest(3, "sanju", "vasu", "sanju@gamil.com");
        Guest guest4 = new Guest(4, "pavan", "kumar", "pavan@gamil.com");
